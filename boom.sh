# A tool by nitro from www.facebook.com/labibmirza11
...
echo -e "$red                 ⫸$ylo facebook.com/labibmirza11$red ⫷$rset"
echo 
# Functions
...
echo " "
echo " "
echo -e "$red               You are going to$grn Boom$red Now$rset"
echo " "
...
echo " "
echo -e "$cyan            click$grn ENTER$cyan to go back into boom  menu$rset"
echo " "
read punch
fi
cd $HOME/Boom/
